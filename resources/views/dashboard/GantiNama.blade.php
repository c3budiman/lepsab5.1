...
@section('isinya')
  ...
  <div class="box box-success">
    ...
    <!-- /.box-header -->
    <!-- form start -->
    <form method="post" action="{{url(action("BackendController@postGantiNama"))}}" class="form-horizontal">
      {{ csrf_field() }}
      <div class="box-body">
        <div class="form-group">
          <label for="inputEmail3" class="col-sm-3 control-label">Nama anda :</label>

          <div class="col-sm-9">
            <input type="text" disabled class="form-control" id="inputEmail3" value="{{Auth::user()->name}}">
          </div>
        </div>
        <div class="form-group">
          <label for="inputPassword3" class="col-sm-3 control-label">Nama Baru :</label>

          <div class="col-sm-9">
            <input name="namabaru" type="text" class="form-control" id="inputPassword3" placeholder="Nama Baru">
          </div>
        </div>

        <div class="form-group">
          <label for="inputPassword4" class="col-sm-3 control-label">Password anda :</label>

          <div class="col-sm-9">
            <input name="password" type="password" class="form-control" id="inputPassword4" placeholder="Konfirmasi dengan Password">
          </div>
        </div>
      </div>
      <!-- /.box-body -->
