...
<html>
  <head>
    ...
    <title>LOGIN BACKEND | Lembaga Pengembangan Sastra dan Bahasa</title>
  </head>
  <body>
                ...
                <div class="row">
                    <div class="col-lg-4 ml-auto mr-auto">
                        <div class="card card-register">
                            ...
                            @endif
                            <form action="{{url(action('loginController@postLogin'))}}" method="post" class="register-form">
                              {{ csrf_field() }}
                                <label>Email</label>
                                ...
                                <button type="submit" class="btn btn-info btn-block btn-round">Log In</button>
                            </form>
                        </div>
                    </div>
                </div>
